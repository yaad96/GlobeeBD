...
if(isset($_GET['categoryId'])) {
    ...
    $var= "SELECT * FROM product where Category=".$CategoryId;
    ...
    $var3= "SELECT * FROM category where categorynumber=".$CategoryId;
    $result3=$conn->query($var3);
    $singlecat=$result3->num_rows;

    $catgLi = array();
    if($singlecat > 0) {
        while ($row=$result3->fetch_assoc()) {
            $catgLi[$index]=array('CategoryId'=>$row['categorynumber'],
								'CategoryName'=>$row['categoryname']);
    ...
    $var3= "SELECT * FROM product";
    $result3=$conn->query($var3);
    $numOfProd=$result3->num_rows;
    ...
    if($numOfProd>0)
    {
        ...
        while ($row=$result3->fetch_assoc()) {
            //if($row['Approval']==1)
            //{
                $prodList[$index]=array('PID'=>$row['PID'],'name'=>$row['name'],
                                'Category'=>$row['Category']);
		...
		<section class="banner-bottom-wthreelayouts py-lg-5 py-3">
			<div class="container-fluid">
				...
				<div class="slider-img mid-sec mt-lg-5 mt-2">
						<!--//banner-sec-->
						<h3 class="tittle-w3layouts text-left my-lg-4 my-3">All Products from <?php echo $catgLi[$index]['CategoryName'];?> </h3>
