										...
										<div class="col-md-4 media-list span4 text-left">
											...
											<ul>
												<li class="media-mini mt-3">
													<a href="shop.php">Oxygen Concentrator</a>
												</li>
											<!--<li class="">
									...
									'<div class = "item">
										...
										<div class="product-googles-info googles">
											<div class="men-pro-item">
												...
												<a href="'.'product.php'.'?pid='.$blogList[$index]['PID'].'">'.
													'<img src="'.$blogList[$index][0].'" class="img-fluid" alt="">'.'</a>'.
														'<div class="men-cart-pro">
															<div class="inner-men-cart-pro">
																<a href="'.'product.php'.'?pid='.$blogList[$index]['PID'].'" class="link-product-add-cart">Quick View</a>
															</div>
														</div>'.
													...
													<div class="info-product-price">
														<div class="grid_meta">
															<div class="product_price">
																<h4>
																	<a href="'.'product.php'.'?pid='.$blogList[$index]['PID'].'"">'.$blogList[$index]['name'].'</a>
																</h4>'.
				...
				<div class="row">
					<div class="col-md-12 middle-slider my-4">
						<div class="middle-text-info ">
							...
							<a href="hospital&lab_list.html">
							<h3  class="tittle-w3layouts two text-center my-lg-4 mt-3">COVID-19 Dedicated Hospitals & Labs</h3></a>
